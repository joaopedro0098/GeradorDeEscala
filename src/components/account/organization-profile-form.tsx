...
export function OrganizationProfileForm({
  ...
  }, [organizationName, logoUrl, isEditingImage]);
  ...
  async function prepareAndSubmit(formData: FormData) {
    ...
    if (isEditingImage && sourceUrl) {
      ...
      if (cropped) {
        formData.set('logoDataUrl', cropped);
  ...
  return (
    <GlassCard className="glass-card p-6">
      ...
      <p className="mt-1 text-sm text-[var(--text-secondary)]">
        Nome e foto da organização aparecem para todos os membros e admins.
      </p>
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
          <div className="flex flex-col items-center gap-3">
            <div
              ...
              aria-label="Alterar foto da organização"
            >
              {displayUrl ? (
          ...
          <div className="min-w-0 flex-1 space-y-4">
            <label className="block text-sm font-semibold text-[var(--text-primary)]">
              ...
              <input
                ...
                placeholder="Defina o nome da organização"
                required
                minLength={2}
